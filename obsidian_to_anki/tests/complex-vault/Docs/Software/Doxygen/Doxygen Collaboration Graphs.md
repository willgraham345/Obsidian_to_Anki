...
Colors
- Arrows
	- Blue = `public` [[CS OOP Inheritance|Inheritance]], or include relation (for include dependency graph)
	- Green = `protected` [[CS OOP Inheritance|Inheritance]]
	- Red = `private` [[CS OOP Inheritance|Inheritance]]
	- Purple dashed = [[CS OOP Association|Association]] (should have label with what is accessible)
