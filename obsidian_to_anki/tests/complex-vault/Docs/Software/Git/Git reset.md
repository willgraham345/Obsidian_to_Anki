...
## Usage
  `git reset --hard origin/branch` ;;; Reset local copy to branch you want your local to be = #tools/git/clean_reset  
ID: 1751997630192



  `git reset` ;;; Revert tracked changes (hard->reset HEAD+working tree)(soft->reset only HEAD) = #tools/git/clean_reset 
ID: 1751997630197
