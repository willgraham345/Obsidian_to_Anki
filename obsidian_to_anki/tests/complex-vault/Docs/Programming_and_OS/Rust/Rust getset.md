...
headings: 
type: 
similar: ["[[Rust derive_getters]]"]
date created: Friday, April 18th 2025, 11:43:11 am
date modified: Tuesday, July 22nd 2025, 10:16:47 am
library_of: ["[[Rust macros]]", "[[Rust]]"]
...
󰠗  How are "Getters" generated in the Rust getset crate? What format do they follow? ;; `fn field(&self) -> &type` = #lang/meta/attributes/macros 
<!--ID: 1758253288768-->

- [p] `use getset::{Getters};`
      `[#derive(Getters)]`
      `pub struct S` = Set generic defaults for getters on a struct/enum on a struct `S` = #lang/meta/attributes/macros 
