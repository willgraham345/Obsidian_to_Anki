...
  `std::bind(function, object/value, args...)` ;;; Binds a function/value to a specific object/value. Creates a new function object by allowing it to be called with a different number of arguments or with a different order of arguments.
