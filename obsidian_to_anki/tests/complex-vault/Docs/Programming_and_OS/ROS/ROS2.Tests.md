...
See [[Python pytest]] python-specific descriptions, and [[ROS2.launch_pytest]] for writing python tests within a ROS2 framework. To launch from CLI, see [[ROS2.Running.Tests.from.CLI]].
