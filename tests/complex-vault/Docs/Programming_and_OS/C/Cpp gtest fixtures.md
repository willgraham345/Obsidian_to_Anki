---
summary: Mechanism for us to set up and tear down common data and objects required by multiple tests within a test suite by inheriting `testing::Test`. Helpful for code reuse.
headings: ["[[#Examples]]", "[[#Usage]]"]
type: note/concept
concept_of: ["[[Cpp GoogleTest|Cpp gtest]]"]
date created: Tuesday, August 20th 2024, 2:05:33 pm
date modified: Tuesday, September 16th 2025, 9:33:20 am
used_by: ["[[Cpp gtest TEST_P]]", "[[Cpp gtest TEST]]"]
---
...
## Usage
  `class FooTest : public testing::Test {}` ;;; Creates a test fixture within Gtest, to be tested within a `TEST()` macro. = #lang/test/gtest/fixtures
<!--ID: 1758253289900-->
