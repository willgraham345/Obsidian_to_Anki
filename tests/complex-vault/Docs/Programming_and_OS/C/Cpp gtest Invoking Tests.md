...
date modified: Friday, January 30th 2026, 11:51:46 am
tags:
  - lang/test/gtest/running-tests
template:
template-version:
process_of:
  - "[[Cpp GoogleTest]]"
...
 `RUN_ALL_TESTS()`
  `./<test-binary> --gtest_output=json:report.json` ;;; Generate a report of the given test binary in json format, titled `report.json` =
<!--ID: 1758253289893-->
