---
summary: Cpp Standard template library, which provides common data structures (lists, stacks, arrays, etc.) and has containers for algorithms and iterators. Subset of the std library.
type: note/library
headings:
concepts: ["[[Cpp STL Associative Containers]]", "[[Cpp.STL Container Adapters]]"]
date created: Tuesday, August 20th 2024, 2:05:33 pm
date modified: Wednesday, January 14th 2026, 12:01:56 pm
items: ["[[Cpp.Smart Pointers]]"]
library_of: ["[[Cpp std]]"]
