...
tags: [lang/meta/attributes/macros/toolingDirectives]
---
# Summary
...
## Usage
  `#derive` ;;; Generates various traits for you
  `#[macro_export]` ;;; Says that the following macro should be brought into scope whenever crate in which macro is defined is brought into scope = #lang/meta/attributes/macros/toolingDirectives 


  `#[macro_export]` ;;; Let macro persist past module, or import from `extern_crate` = #lang/meta/attributes/macros/toolingDirectives 


  `#[proc_macro]` ;;; Mark `fn` as a function-like procedural macro, callable as `m!()` = #lang/meta/attributes/macros/toolingDirectives 
ID: 1751997627848



  `#[proc_macro_derive(Foo)]` ;;; Mark `fn` as a derive macro, which can `#[derive(Foo)]` = #lang/meta/attributes/macros/toolingDirectives 
