...
## Concepts of Note
󰙎  [Mutable statics](https://doc.rust-lang.org/reference/items/static-items.html#statics--generics) ;;; Allowed to be modified by the program. An `unsafe` block is required when reading/writing a mutable static variable.
