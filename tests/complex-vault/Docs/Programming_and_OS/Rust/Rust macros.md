...
libraries:
  - "[[Rust getset]]"
tags:
  - lang/meta/attributes/macros
  - lang/meta/attributes/macros/toolingDirectives
---
# Summary
`VIEW[**{summary}**][text(renderMarkdown)]`

# Additional Background
󰙎  Macro ;;; An expandable section of code, which can take variable number of parameters.
