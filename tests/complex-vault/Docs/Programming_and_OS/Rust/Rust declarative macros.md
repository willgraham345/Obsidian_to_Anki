...
date modified: Monday, August 18th 2025, 3:15:06 pm
---
...
## Concepts of Note
󰙎  Declarative macros ;;; Macros with the `macro_rules!` at the front. Allows you to write control structures that take expressions, compare result to patterns, and running code associated with that pattern. = #lang/macros/declarative 
<!--ID: 1758253288882-->
