...
󰙎  Crate ;;; Unit of compilation/linking. Contains a tree of nested module scopes, where level of the tree is a module that is anonymous to any item within this unit. = #lang  
