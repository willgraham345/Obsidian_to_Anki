---
summary: Zero-sized type used to mark things that "act like" they own a `T`. Adding `PhantomData<T>` field to your type tells the compiler that your types as though it stores a value of type `T`, even though it doesn't really. See the link for more information.
headings:
  - "[[#Concepts of Note]]"
  - "[[#Usage]]"
type: 
date created: Monday, June 9th 2025, 12:22:26 pm
date modified: Monday, July 14th 2025, 1:18:08 pm
---
...
󰠗  Why would you want to use `PhantomData`? ;; When you want the compiler to act as though your types are storing data for a value type of `T`, but keep that data non-existent.
