...
# Usage
  `cat /proc/filesystems` ;;; View file system types Linux supports = #cs/linux  
ID: 1751997628793



  `mount` ;;; View currently mounted file systems on Linux = #cs/linux  
ID: 1751997628797



  `mount -t <type> <device> <dir>` ;;; Tells kernel to attach filesystem found at device to the dir = #cs/linux = `-l` lists all filesystems mounted yet 
<!--ID: 1758253289459-->
...
  `findmnt` ;;; Explore mounted file systems in a tree structure = #cs/linux = `-t` Use a filter 
ID: 1751997628805
