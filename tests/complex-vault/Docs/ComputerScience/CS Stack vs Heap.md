...
## Concepts of Note
󰙎  Call stack ;;; part of the stack responsible for function and method control. Function calls add functions to the top of the stack, which return control to the caller of the function. `main()` (or its equivalent) is at the bottom of the stack. ^0eb195
