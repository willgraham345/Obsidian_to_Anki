...
---
# Summary
󰙎 Networking SSH Keys ;;; How ssh deals with authentication. There is a private key as well as a public key. Private key should be kept secret, the public can be put anywhere. The private key is used to pretend to be yourself. Public key can be generated from the private key, but not vice versa. The idea
