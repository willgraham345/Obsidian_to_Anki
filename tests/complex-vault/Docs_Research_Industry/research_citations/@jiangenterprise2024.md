---
summary: Good enterprise architecture overview.
rating: 3
reading-status: almost-finished
...
associations:
  - "[[@8968909]]"
  - "[[@kinderenreference2023|A Reference Model and a Dedicated Method in Support of Cyber-Security by Design: A Reality Check]]"
attachment:
...
date modified: Thursday, September 4th 2025, 10:03:00 am
...
related:
  - []
review_of: "[[Cybersecurity Research]]"
tags:
  - cs/security
...
## Notes
󰙎  Enterprise architecture ;;; Defines organization's structure and operation, aligning business processes, IS, 

### What enterprise architecture reference modeling frameworks/models have been explored?
󰙎  TOGAF ;;; Enterprise architecture, technology-independent. Doesn't prescribe a modeling language. 
󰙎  Zachman framework ;;; Enterprise architecture (unfinished)
󰙎  Archimate ;;; Enterprise model (unfinished)
󰙎  Aris ;;; Enterprise model
󰙎  CIS Control Community ;;; Cybersecurity framework.
󰙎  GERAM ;;; (Generalized Enterprise Reference Architecture and Methodology) Comprehensive framework that covers a wide range of facets related to enterprise engineering
󰙎  SABSA ;;; (Sherwood Applied Business Security Architecture) similar to the Zachman framework, but aimed at risk/security aspects (What/Why/How/Who/Where/When). Analyzes trust relationships between entities to identify security requirements.
